const getRemainTime = deadline => {
    ...
    const timerUpdate = setInterval(() => {
      ...
      elemt.innerHTML = `
        <div id="timedown">
          ...
          <div class="seconds">${t.remainSeconds}<div class="text">Seg.</div></div>
        </div>
        ` 
      if(t.reamainTime <= 3) {
  ...
  countDown('Jul 30 2021 21:50:30 GMT-0500', 'main', '<div class="time-over" style="font-size:xx-large; float:left">El tiempo se ha acabado</div>')
